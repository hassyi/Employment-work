...
void AnimationModelCPU::Load(const char* FileName)
{
...
void AnimationModelCPU::LoadAnimation(const char* FileName, const char* Name)
{
	m_Animation[Name] = aiImportFile(FileName, aiProcess_ConvertToLeftHanded);
	assert(m_Animation[Name]);
}

void AnimationModelCPU::CreateBone(aiNode* node)
{
	BONE bone;
...
void AnimationModelCPU::UpdateAnimation(const char* AnimationName1, int Frame1,
...
void AnimationModelCPU::UpdateBoneMatrix(aiNode* node, aiMatrix4x4 matrix)
{
