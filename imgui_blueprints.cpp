...
void ImGuiBluePrint::Init()
{
    ...
    config.LoadNodeSettings = [](ed::NodeId nodeId, char* data, void* userPointer) -> size_t
        {
            auto self = static_cast<ImGuiBluePrint*>(userPointer);
    ...
    m_HeaderBackground = LoadTexture("asset/texture/BlueprintBackground.png");
    m_SaveIcon = LoadTexture("asset/texture/ic_save_white_24dp.png");
    m_RestoreIcon = LoadTexture("asset/texture/ic_restore_white_24dp.png");
}

void ImGuiBluePrint::Uninit()
{
...
void ImGuiBluePrint::BuildNode(Node* node)
{
    for (auto& input : node->Inputs)
    {
        input.Node = node;
...
void ImGuiBluePrint::BuildNodes()
{
    for (auto& node : m_Nodes)
        BuildNode(&node);
}

void ImGuiBluePrint::TouchNode(ed::NodeId id)
{
    m_NodeTouchTime[id] = m_TouchTime;
}

void ImGuiBluePrint::UpdateTouch()
{
...
void ImGuiBluePrint::DrawPinIcon(const Pin& pin, bool connected, int alpha)
{
    IconType iconType;
    ...
    switch (pin.Type)
    {
    case PinType::Flow:     iconType = IconType::Flow;   
        break;
    case PinType::Bool:     iconType = IconType::Circle;
        break;
    case PinType::Int:      iconType = IconType::Circle;
        break;
    case PinType::Float:    iconType = IconType::Circle;
        break;
    case PinType::String:   iconType = IconType::Circle;
        break;
    case PinType::Object:   iconType = IconType::Circle;
        break;
    case PinType::Function: iconType = IconType::Circle;
        break;
    case PinType::Delegate: iconType = IconType::Square;
        break;
    default:
        return;
    }
...
void ImGuiBluePrint::ShowStyleEditor(bool* show)
{
...
void ImGuiBluePrint::ShowLeftPane(float paneWidth)
{
    auto& io = ImGui::GetIO();
...
Node* ImGuiBluePrint::SpawnInputActionNode()
{
...
Node* ImGuiBluePrint::SpawnBranchNode()
{
...
Node* ImGuiBluePrint::SpawnDoNNode()
{
...
Node* ImGuiBluePrint::SpawnOutputActionNode()
{
...
Node* ImGuiBluePrint::SpawnPrintStringNode()
{
...
Node* ImGuiBluePrint::SpawnMessageNode()
{
...
Node* ImGuiBluePrint::SpawnSetTimerNode()
{
...
Node* ImGuiBluePrint::SpawnLessNode()
{
    m_Nodes.emplace_back(GetNextId(), "<", ImColor(128, 195, 248));
    m_Nodes.back().Type = NodeType::Simple;
...
Node* ImGuiBluePrint::SpawnWeirdNode()
{
...
Node* ImGuiBluePrint::SpawnTraceByChannelNode()
{
...
Node* ImGuiBluePrint::SpawnTreeSequenceNode()
{
...
Node* ImGuiBluePrint::SpawnTreeTaskNode()
{
...
Node* ImGuiBluePrint::SpawnTreeTask2Node()
{
...
Node* ImGuiBluePrint::SpawnComment()
{
...
Node* ImGuiBluePrint::SpawnHoudiniTransformNode()
{
...
Node* ImGuiBluePrint::SpawnHoudiniGroupNode()
{
...
Node* ImGuiBluePrint::FindNode(ed::NodeId id)
{
    for (auto& node : m_Nodes)
        if (node.ID == id)
            return &node;
...
Link* ImGuiBluePrint::FindLink(ed::LinkId id)
{
    for (auto& link : m_Links)
        if (link.ID == id)
            return &link;
...
Pin* ImGuiBluePrint::FindPin(ed::PinId id)
{
...
float ImGuiBluePrint::GetTouchProgress(ed::NodeId id)
{
...
ImColor ImGuiBluePrint::GetIconColor(PinType type)
{
    switch (type)
    {
    default:
...
bool ImGuiBluePrint::IsPinLinked(ed::PinId id)
{
    if (!id) return false;
...
bool ImGuiBluePrint::CanCreateLink(Pin* a, Pin* b)
{
...
ImTextureID ImGuiBluePrint::LoadTexture(const char* path)
{
